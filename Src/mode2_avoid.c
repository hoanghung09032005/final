...
#define AVOID_SAFETY_TIMEOUT     400     /* Timeout 4s: Tránh xe chạy lố khỏi bàn */

#define AVOID_PIVOT_SPEED         700    /* PWM xoay lách ra/quặt vào */
#define AVOID_ALIGN_SPEED         800    /* PWM bơm mạnh để nắn thẳng, chống đì */
#define AVOID_SPEED               400    /* PWM tiến thẳng khi né */

#define AVOID_PIVOT_OUT_CYCLES    25     /* Xoay lách ra (250ms) */
#define AVOID_FORWARD_SIDE_CYCLES 200    /* Tiến song song vật cản (2s) */
#define AVOID_PIVOT_BACK_CYCLES   35     /* Quặt hướng về line (350ms) */
